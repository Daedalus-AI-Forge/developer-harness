...
description: Write docstrings that document each function's contract. Identifies input invariants, errors raised on violation, errors from external state, and silenced errors from callees. Invoke explicitly on a chosen scope — pass a file, directory, or a description of what to focus on — rather than triggering it automatically.
---
