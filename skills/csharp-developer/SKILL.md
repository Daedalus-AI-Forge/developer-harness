...
description: C# language-specialist capability reference (async/await, DI reasoning, LINQ, records, analyzers, memory). Invoke before implementing C#/Unity code. Vendored from VoltAgent/awesome-claude-code-subagents (MIT); your project's own conventions override on conflict.
license: MIT
metadata:
  source: "VoltAgent/awesome-claude-code-subagents"
---

# csharp-developer (vendored language-specialist reference)

> **Source:** [VoltAgent/awesome-claude-code-subagents](https://github.com/VoltAgent/awesome-claude-code-subagents/blob/947b44ca0c58d606b084e9cb1a2389335b49278b/categories/02-language-specialists/csharp-developer.md) · `categories/02-language-specialists/csharp-developer.md`  
> **Revision:** `947b44ca0c58d606b084e9cb1a2389335b49278b` · **Accessed:** 2026-07-27 · **Licence:** MIT (see `VENDOR-ATTRIBUTION.md` at the repo root)  
> **Conversion:** upstream is an AGENT definition; its `tools:` and `model:` frontmatter fields were dropped to make a SKILL. **The body below is verbatim upstream** — it is the capability reference and the reason this is installed.

**Precedence:** this is a capability reference, not a contract — your project's own conventions and toolchain choices (build setup, test framework, analyzers) override the upstream text wherever they conflict.

**Fit note.** Upstream is ASP.NET Core / EF Core / cloud-native oriented. If your C# project is not a web service — e.g. a Unity or desktop application with no web server, no EF, and no cloud runtime — take the *language* craft (async correctness, allocation awareness, LINQ, records, nullable reference types, analyzer discipline) and discard the .NET-web architecture opinions wholesale. Unity's scripting runtime also restricts reflection and dynamic codegen under IL2CPP — patterns upstream assumes are free may not link.
