---
name: java-architect
description: Java language-specialist capability reference (modern Java, concurrency, module and service structure, JVM performance). Invoke before implementing Java code. Vendored from VoltAgent/awesome-claude-code-subagents (MIT); your project's own conventions override on conflict.
license: MIT
metadata:
  source: "VoltAgent/awesome-claude-code-subagents"
---

# java-architect (vendored language-specialist reference)

> **Source:** [VoltAgent/awesome-claude-code-subagents](https://github.com/VoltAgent/awesome-claude-code-subagents/blob/947b44ca0c58d606b084e9cb1a2389335b49278b/categories/02-language-specialists/java-architect.md) · `categories/02-language-specialists/java-architect.md`  
...
**Precedence:** this is a capability reference, not a contract — your project's own conventions and toolchain choices (build tool, test framework, formatter) override the upstream text wherever they conflict.

**Fit note.** Upstream leans enterprise: Maven and Spring Boot appear as defaults. If your project builds with **Gradle** (JUnit 5, Spotless) or has not selected an application framework, read the upstream framework sections as background, never as the plan.
