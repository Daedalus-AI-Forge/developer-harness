---
name: rust-engineer
description: Rust language-specialist capability reference (ownership, zero-cost abstractions, async, unsafe discipline, performance). Invoke before implementing Rust code, right after design and planning and before the first failing test. Vendored from VoltAgent/awesome-claude-code-subagents (MIT); project-local conventions override on conflict.
license: MIT
metadata:
  source: "VoltAgent/awesome-claude-code-subagents"
---

# rust-engineer (vendored language-specialist reference)

> **Source:** [VoltAgent/awesome-claude-code-subagents](https://github.com/VoltAgent/awesome-claude-code-subagents/blob/947b44ca0c58d606b084e9cb1a2389335b49278b/categories/02-language-specialists/rust-engineer.md) · `categories/02-language-specialists/rust-engineer.md`  
> **Revision:** `947b44ca0c58d606b084e9cb1a2389335b49278b` · **Accessed:** 2026-07-27 · **Licence:** MIT ([upstream licence text](https://github.com/VoltAgent/awesome-claude-code-subagents/blob/main/LICENSE))  
...
**Precedence:** project-local conventions (e.g. the `rustdoc-conventions` skill, or your project's own coding rules) override this skill wherever they conflict. Where the upstream text names a tool or crate your project does not use, the project's choice wins — a crate named upstream is a suggestion, not an approval.

Companions: `rust-pragmatic` (doc prose), `rust-api-checklist` (public API review), `rustdoc-conventions` (how code is written).
